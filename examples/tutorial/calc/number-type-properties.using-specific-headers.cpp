...
#include <cppx-core-language/tmp/type-traits.hpp>               // cppx::is_floating_point__
#include <cppx-core-language/type-checking/type_name_of_.hpp>   // cppx::type_name_of_

#include <iostream>     // std::(cout, endl)
#include <iomanip>      // std::setw
$use_std( cout, endl, setw, left, right, fixed, setprecision, boolalpha );
...
void display_properties_of_type_()
{
    ...
    display_fields( widths,
        type_name_of_<Type>(),
        smallest_<Type>, largest_<Type>, min_<Type>, max_<Type>,
        n_digits_<Type>
        );
    if constexpr( is_floating_point_<Type> ) {
        display_fields( widths,
            is_ieee_754_<Type>,
            min_exp_<Type>, max_exp_<Type>, radix_<Type>,
            epsilon_<Type>
            );
    }
    cout << endl;
