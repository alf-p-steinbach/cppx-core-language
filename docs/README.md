...
- [Core Language Extensions](#core-language-extensions)
  ...
  - [3. Examples & details.](#3-examples--details)
    ...
    - [3.1. The bit-level stuff.](#31-the-bit-level-stuff)
      - [3.1.1. Examples for header “bit-level/Bits_width.hpp”.](#311-examples-for-header-bit-levelbits_widthhpp)
...
Headers:
- 3.1.1. “bit-level/[Bit_width.hpp](#311-examples-for-header-bit-levelbits_widthhpp)”
